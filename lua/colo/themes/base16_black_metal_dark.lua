---@module "colo.themes.base16_black_metal_dark"
---@author dharmx
---@license GPL-3.0
...
return {
  ...
  green = Color:new({ hexcode = "#dd9999" }),
  yellow = Color:new({ hexcode = "#a06666" }),
  ...
  bright_green = Color:new({ hexcode = "#dd9999" }),
  bright_yellow = Color:new({ hexcode = "#a06666" }),
