...
return {
  ...
  bright_magenta = Color:new({ hex = "#d33682" }),
  bright_cyan = Color:new({ hex = "#2aa198" }),
  bright_white = Color:new({ hex = "#073642" }),
}
