---@module "colo.themes.base16_harmonic_light"
---@author dharmx
---@license GPL-3.0
...
return {
  ...
  description = "",
  source = "https://github.com/dylanaraps/pywal/tree/master/pywal/colorschemes/light/base16-harmonic.json",
  background = "light",
  black = Color:new({ hexcode = "#f7f9fb" }),
  ...
  white = Color:new({ hexcode = "#405c79" }),
  bright_black = Color:new({ hexcode = "#aabcce" }),
  ...
  bright_white = Color:new({ hexcode = "#0b1c2c" }),
}
