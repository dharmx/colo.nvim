---@module "colo.themes.base16_black_metal_funeral_dark"
---@author dharmx
---@license GPL-3.0
...
return {
  ...
  description = "",
  source = "https://github.com/dylanaraps/pywal/tree/master/pywal/colorschemes/dark/base16-black-metal-funeral.json",
  background = "dark",
  black = Color:new({ hex = "#000000" }),
  red = Color:new({ hex = "#5f8787" }),
  green = Color:new({ hex = "#d0dfee" }),
  yellow = Color:new({ hex = "#5f81a5" }),
  ...
  bright_green = Color:new({ hex = "#d0dfee" }),
  bright_yellow = Color:new({ hex = "#5f81a5" }),
