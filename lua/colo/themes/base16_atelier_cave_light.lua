---@module "colo.themes.base16_atelier_cave_light"
---@author dharmx
---@license GPL-3.0
...
return {
  ...
  description = "",
  source = "https://github.com/dylanaraps/pywal/tree/master/pywal/colorschemes/light/base16-atelier-cave.json",
  background = "light",
  black = Color:new({ hex = "#efecf4" }),
  ...
  white = Color:new({ hex = "#585260" }),
  bright_black = Color:new({ hex = "#7e7887" }),
  ...
  bright_white = Color:new({ hex = "#19171c" }),
}
