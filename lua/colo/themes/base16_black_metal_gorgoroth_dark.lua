---@module "colo.themes.base16_black_metal_gorgoroth_dark"
---@author dharmx
---@license GPL-3.0
...
return {
  ...
  description = "",
  source = "https://github.com/dylanaraps/pywal/tree/master/pywal/colorschemes/dark/base16-black-metal-gorgoroth.json",
  background = "dark",
  black = Color:new({ hexcode = "#000000" }),
  red = Color:new({ hexcode = "#5f8787" }),
  green = Color:new({ hexcode = "#9b8d7f" }),
  yellow = Color:new({ hexcode = "#8c7f70" }),
  ...
  bright_green = Color:new({ hexcode = "#9b8d7f" }),
  bright_yellow = Color:new({ hexcode = "#8c7f70" }),
