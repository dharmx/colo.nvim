...
function M.prime(c)
  return {
    ...
    NUINormal = { background = c.black:brighten(1):lighten(2):darken(1), foreground = c.black:brighten(1):lighten(2):darken(1) },
    ...
    FloatBorder = { background = c.black:brighten(1):lighten(2):darken(1), foreground = c.black:brighten(1):lighten(2):darken(1) },
    ...
    HarpoonCursor = { background = c.bright_black:lighten(1), foreground = c.blue },
  }
end
