...
return {
  ...
  description = "",
  source = "https://github.com/dylanaraps/pywal/tree/master/pywal/colorschemes/light/base16-atelier-seaside.json",
  background = "light",
  black = Color:new({ hex = "#f4fbf4" }),
  ...
  white = Color:new({ hex = "#5e6e5e" }),
  bright_black = Color:new({ hex = "#809980" }),
