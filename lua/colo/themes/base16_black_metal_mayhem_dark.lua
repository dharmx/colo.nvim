---@module "colo.themes.base16_black_metal_mayhem_dark"
---@author dharmx
---@license GPL-3.0
...
return {
  ...
  green = Color:new({ hexcode = "#f3ecd4" }),
  yellow = Color:new({ hexcode = "#eecc6c" }),
  ...
  bright_green = Color:new({ hexcode = "#f3ecd4" }),
  bright_yellow = Color:new({ hexcode = "#eecc6c" }),
