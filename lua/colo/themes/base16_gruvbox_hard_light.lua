---@module "colo.themes.base16_gruvbox_hard_light"
---@author dharmx
---@license GPL-3.0
...
return {
  ...
  description = "",
  source = "https://github.com/dylanaraps/pywal/tree/master/pywal/colorschemes/light/base16-gruvbox-hard.json",
  background = "light",
  black = Color:new({ hexcode = "#f9f5d7" }),
