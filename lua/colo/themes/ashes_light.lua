---@module "colo.themes.ashes_light"
---@author dharmx
---@license GPL-3.0
...
return {
  ...
  name = "ashes",
  description = "",
  source = "https://github.com/dylanaraps/pywal/tree/master/pywal/colorschemes/light/ashes.json",
  background = "light",
  black = Color:new({ hexcode = "#f3f4f5" }),
  ...
  white = Color:new({ hexcode = "#1c2023" }),
  ...
  bright_white = Color:new({ hexcode = "#1c2023" }),
}
