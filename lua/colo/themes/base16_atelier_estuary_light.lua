---@module "colo.themes.base16_atelier_estuary_light"
---@author dharmx
---@license GPL-3.0
...
return {
  ...
  background = "light",
  black = Color:new({ hexcode = "#f4f3ec" }),
  ...
  white = Color:new({ hexcode = "#5f5e4e" }),
  bright_black = Color:new({ hexcode = "#878573" }),
  ...
  bright_white = Color:new({ hexcode = "#22221b" }),
}
