---@module "colo.themes.base16_gruvbox_soft_dark"
---@author dharmx
---@license GPL-3.0
...
return {
  ...
  description = "",
  source = "https://github.com/dylanaraps/pywal/tree/master/pywal/colorschemes/dark/base16-gruvbox-soft.json",
  background = "dark",
  black = Color:new({ hexcode = "#32302f" }),
