---@module "colo.themes.base16_black_metal_bathory_dark"
---@author dharmx
---@license GPL-3.0
...
return {
  ...
  description = "",
  source = "https://github.com/dylanaraps/pywal/tree/master/pywal/colorschemes/dark/base16-black-metal-bathory.json",
  background = "dark",
  black = Color:new({ hexcode = "#000000" }),
  red = Color:new({ hexcode = "#5f8787" }),
  green = Color:new({ hexcode = "#fbcb97" }),
  yellow = Color:new({ hexcode = "#e78a53" }),
  ...
  bright_green = Color:new({ hexcode = "#fbcb97" }),
  bright_yellow = Color:new({ hexcode = "#e78a53" }),
