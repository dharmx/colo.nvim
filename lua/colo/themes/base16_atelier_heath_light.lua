---@module "colo.themes.base16_atelier_heath_light"
---@author dharmx
---@license GPL-3.0
...
return {
  ...
  description = "",
  source = "https://github.com/dylanaraps/pywal/tree/master/pywal/colorschemes/light/base16-atelier-heath.json",
  background = "light",
  black = Color:new({ hexcode = "#f7f3f7" }),
  ...
  white = Color:new({ hexcode = "#695d69" }),
  bright_black = Color:new({ hexcode = "#9e8f9e" }),
  ...
  bright_white = Color:new({ hexcode = "#1b181b" }),
}
